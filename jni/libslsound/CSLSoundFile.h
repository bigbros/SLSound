...
protected:
	...
	short			m_depth;	// 1チャネル1サンプルあたりのサイズ(1 or 2)
	short			m_block;	// ブロックサイズ(1サンプルあたりの全チャネル合計サイズ)
	long			m_length;	// 音源全体のブロック数

	long			m_packet;	// パケットサイズ(一回の読み出しで読み出すことが推奨されるサイズ(byte) */
